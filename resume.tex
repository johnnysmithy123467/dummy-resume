\documentclass[a4paper]{article}
    \usepackage{fullpage}
    \usepackage{amsmath}
    \usepackage{amssymb}\textit{}
    \usepackage{textcomp}
    \usepackage[utf8]{inputenc}
    \usepackage[T1]{fontenc}
    \usepackage{hyperref}
    \textheight=10in
    \pagestyle{empty}\textit{\textit{}}
    \raggedright
    \usepackage[left=0.8in,right=0.8in,bottom=0.8in,top=0.8in]{geometry}\textit{\textit{}}
...
%==== Volunt\textit{\textit{\textit{\textit{\textit{}}}}}eering/Clubs ====%
